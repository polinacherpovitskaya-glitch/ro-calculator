...
bot.onText(/\/help/, async (msg) => {
    await send(
        msg.chat.id,
        'Этот бот присылает уведомления по задачам: когда тебе назначили задачу, когда меняется статус по твоим задачам и задачам, где ты наблюдатель, а также когда тебя упоминают.'
    );
});
