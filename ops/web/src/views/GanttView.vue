...
.timeline { background: white; border: 1px solid #d9e2ec; overflow-x: auto; } .scale, .row { display: grid; grid-template-columns: 18rem minmax(56rem, 1fr); } .scale { position: sticky; top: 0; z-index: 1; background: #f8fafc; border-bottom: 1px solid #d9e2ec; } .scale b { display: inline-block; min-width: calc(100% / 21); padding: .55rem 0; color: #52606d; font-size: .72rem; text-align: center; }
