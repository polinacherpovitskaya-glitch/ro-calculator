...
.timeline { background: white; border: 1px solid #d9e2ec; border-radius: 8px; overflow-x: auto; } .scale, .row { display: grid; grid-template-columns: 18rem minmax(56rem, 1fr); } .scale { position: sticky; top: 0; z-index: 1; background: #f8fafc; border-bottom: 1px solid #d9e2ec; } .scale-label { padding: .65rem; color: #52606d; font-size: .76rem; font-weight: 800; text-transform: uppercase; } .scale-days { display: grid; grid-template-columns: repeat(21, minmax(2.65rem, 1fr)); } .scale b { padding: .65rem 0; color: #52606d; font-size: .72rem; text-align: center; border-left: 1px solid #eef2f6; }
