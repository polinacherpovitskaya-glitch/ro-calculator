...
.month, .editor { background: white; border: 1px solid #d9e2ec; border-radius: 8px; padding: .85rem; } .weekdays, .grid { display: grid; grid-template-columns: repeat(7, minmax(0, 1fr)); gap: .25rem; } .weekdays { margin: .65rem 0 .3rem; color: #697586; font-size: .72rem; text-align: center; } .grid .day { min-width: 0; height: 3rem; display: grid; align-content: center; justify-items: center; gap: .16rem; border: 1px solid #d9e2ec; border-radius: 6px; background: #f2f5f8; padding: 0; cursor: pointer; } .day-number { font-weight: 650; line-height: 1; } .day-hours { color: #697586; font-size: .68rem; line-height: 1; white-space: nowrap; } .day.working { background: #eef8f1; border-color: #b7dfc3; } .day.weekend { background: #f3f4f6; color: #697586; } .day.picked { outline: 2px solid #315c96; }
