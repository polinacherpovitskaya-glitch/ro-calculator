    ...
    syncDatabaseStatusBanner() {
        ...
        if (accessProblem || connectionProblem || localUnsynced) {
            banner.textContent = accessProblem
                ...
                : connectionProblem
                    ? 'Связь с общей базой нестабильна — безопасно переподключаемся. Последнее сохранение пока не подтверждено; не нажимайте кнопку много раз. Дождитесь исчезновения плашки и обновите страницу для проверки.'
