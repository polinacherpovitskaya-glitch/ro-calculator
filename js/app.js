    ...
    syncDatabaseStatusBanner() {
        ...
        if (accessProblem || connectionProblem || localUnsynced) {
            banner.textContent = accessProblem
                ...
                : connectionProblem
                    ? 'Связь с общей базой нестабильна — переподключаемся. Последнее действие могло сохраниться частично; не повторяйте его много раз. Дождитесь исчезновения плашки и обновите страницу для проверки.'
